...
void houseType::set(string s, int bed, int bath, int cg, int yb, int fs, double pr, double tx){
    style = s; 
    numOfBedrooms = bed; 
    numOfBathrooms = bath; 
    numOfCarsGarage = cg; 
...
void houseType::print() const
{
    ...
    cout << "Finished squared footage: " << finishedSquareFootage << endl;
...
houseType::houseType(string s, int bed, int bath, int cg, int yb, int fs, double pr, double tx){
        style = s; 
    numOfBedrooms = bed; 
    numOfBathrooms = bath; 
    numOfCarsGarage = cg; 
